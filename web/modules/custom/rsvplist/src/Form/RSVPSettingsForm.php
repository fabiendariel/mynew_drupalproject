...
/**
 * @file
 * Contains the settings for administating the RSVP form.
 */
...
class RSVPSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['rsvplist_types'] = [
      ...
      '#options' => $types,
      '#description' => $this->t("On the specified noen types, an RSVP option will be available and can be enabled while the node is being edited"),
    ];
